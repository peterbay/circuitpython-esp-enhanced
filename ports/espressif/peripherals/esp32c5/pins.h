...
// SOC_GPIO_PIN_COUNT is 29 on this part, GPIO0 to GPIO28, all of them valid for
// both input and output (SOC_GPIO_VALID_OUTPUT_GPIO_MASK equals the input mask).
