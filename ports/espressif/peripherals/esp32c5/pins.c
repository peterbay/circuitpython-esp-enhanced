...
// ADC1 covers GPIO1 to GPIO6 as channels 0 to 5, per
// components/soc/esp32c5/include/soc/adc_channel.h. There is no ADC2 and no
// touch peripheral on this part.
